package com.example.keygen.core.service.impl;

import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import com.baomidou.mybatisplus.extension.service.impl.ServiceImpl;
import com.example.keygen.core.common.Result;
import com.example.keygen.core.common.Status;
import com.example.keygen.core.dao.IDAllocMapper;
import com.example.keygen.core.model.LeafAlloc;
import com.example.keygen.core.model.Segment;
import com.example.keygen.core.model.SegmentBuffer;
import com.example.keygen.core.service.IDAllocService;
...
/**
 * @calss name IDAllocServiceImpl
 * @description:
 * @author: yichuan
 * @create time: 2020/06/06 16:32
 */
@Service
@Slf4j
public class IDAllocServiceImpl extends ServiceImpl<IDAllocMapper, LeafAlloc>
        implements IDAllocService, IDGen {
     ...
     * IDCache未初始化成功时的异常码
     */
    private static final long EXCEPTION_ID_ICAHN_INIT_FALSE = -1;
    /**
     * key不存在时的异常码
     */
    ...
    public Result get(final String key) {
        if (!initOK) {
            return new Result(EXCEPTION_ID_ICAHN_INIT_FALSE, Status.EXCEPTION);
        }
    ...
    public LeafAlloc updateMaxIdAndGetLeafAlloc(String tag) {
        ...
        queryWrapper.lambda().eq(LeafAlloc::getBizTag, tag);
    ...
    public LeafAlloc updateMaxIdByCustomStepAndGetLeafAlloc(LeafAlloc leafAlloc) {
        ...
        QueryWrapper<LeafAlloc> queryWrapper = new QueryWrapper<>();
        queryWrapper.lambda().eq(LeafAlloc::getBizTag, leafAlloc.getBizTag());
        return getOne(queryWrapper);
    }
