...
| 服务名称 | addr-url | 备注 |
| :-----| :---- | :---- |
| OAUTH2-SERVER | http://localhost:8089 |oauth2授权服务器|
| CLOUD-ADMIN-SERVER | http://localhost:7001 | cloud-admin |
| ADDRESS-SERVER | http://localhost:8081 |地址信息API|
| FILM-SERVER | http://localhost:8083 |影片信息API|
| EUREKA-SERVER | http://localhost:9000 | eureka-server|
| ZUUL-OAUTH-GATEWAY | http://localhost:9001 | gateway|
